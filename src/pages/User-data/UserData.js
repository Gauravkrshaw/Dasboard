...
const UserData = () => {
    const [users, setUsers] = useState([
        { id: 1, name: 'gaurav', email: 'Gaurav@example.com', status: 'Active', role: 'Admin' },
        { id: 2, name: 'rahul', email: 'rahul@example.com', status: 'Inactive', role: 'User' },
        { id: 3, name: 'shree', email: 'Shree@example.com', status: 'Active', role: 'User' },
        { id: 4, name: 'mahabir', email: 'mahabir@example.com', status: 'Active', role: 'Editor' },
        { id: 5, name: 'arpit', email: 'arpit@example.com', status: 'Inactive', role: 'User' },
    ]);
